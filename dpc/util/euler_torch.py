...
import torch
from util.quaternion_torch import quaternion_multiply_np as q_mul_np
...
def quaternion2euler_full_tf(q, rotseq="yzy"):
    def twoaxisrot_tf(r11, r12, r21, r31, r32):
        a0 = torch.atan2(r11, r12)
        a1 = torch.acos(r21)
        a2 = torch.atan2(r31, r32)
        return torch.stack([a0, a1, a2], dim=-1)

    def threeaxisrot_tf(r11, r12, r21, r31, r32):
        a0 = torch.atan2(r31, r32)
        a1 = torch.asin(torch.clamp(r21, -1.0, 1.0))
        a2 = torch.atan2(r11, r12)
        return torch.stack([a0, a1, a2], dim=-1)
